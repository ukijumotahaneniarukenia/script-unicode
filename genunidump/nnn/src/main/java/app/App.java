...
public class App {
    ...
    private static final String PROGRAM_NAME = "genunidump";
    ...
    private static void usage(){
        ...
        System.out.println("Usageだよーん" +
                RS +
                RS +
                "java -jar "+PROGRAM_NAME+"-"+PROGRAM_VERSION+"-SNAPSHOT.jar 0 160" +
                RS +
                RS +
                "java -jar "+PROGRAM_NAME+"-"+PROGRAM_VERSION+"-SNAPSHOT.jar 160 300" +
                RS +
                RS
        );
        System.exit(0);
