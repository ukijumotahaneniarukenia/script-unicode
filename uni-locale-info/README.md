...
```
$ java -jar uni-locale-info-1-0-0-SNAPSHOT-jar-with-dependencies.jar
Usageだよーん
...
java -jar uni-locale-info-1-0-0-SNAPSHOT-jar-with-dependencies.jar --help af zh

java -jar uni-locale-info-1-0-0-SNAPSHOT-jar-with-dependencies.jar --help zh

java -jar uni-locale-info-1-0-0-SNAPSHOT-jar-with-dependencies.jar zh
