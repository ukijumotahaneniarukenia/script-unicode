...
public class App {
    ...
    private static final String PROGRAM_NAME = "gengengen";
    ...
    private static void Usage(){
        ...
        System.out.println("Usageだよーん\n" +
                ...
                "\n" +
                "java -jar "+PROGRAM_NAME+"-"+PROGRAM_VERSION+"-SNAPSHOT.jar " + OPTION_HELP +"\n" +
                "\n" +
                "java -jar "+PROGRAM_NAME+"-"+PROGRAM_VERSION+"-SNAPSHOT.jar " + OPTION_PROPERTY_EAST_ASIAN_WIDTH + " " + OPTION_PROPERTY_GRAPHEME_CLUSTER_BREAK +"\n" +
                "\n" +
                "java -jar "+PROGRAM_NAME+"-"+PROGRAM_VERSION+"-SNAPSHOT.jar " + OPTION_PROPERTY_DECOMPOSITION_TYPE +"\n" +
                "\n" +
                ""
        );
        System.exit(0);
