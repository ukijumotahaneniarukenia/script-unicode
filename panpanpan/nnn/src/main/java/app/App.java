...
public class App {
    ...
    private static final String PROGRAM_NAME = "panpanpan";
    ...
    private static final String UNICODE_GRAPH_LIST = "unicodeGraphList";
    ...
    private static void Usage(){
        ...
        System.out.println("Usageだよーん\n" +
                "\n" +
                "java -jar "+PROGRAM_NAME+"-"+PROGRAM_VERSION+"-SNAPSHOT.jar " + "'" + OPTION_USAGE_PATTERN + "'" +"\n" +
                "\n" +
                ""
        );
        System.exit(0);
